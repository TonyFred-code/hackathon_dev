...
import "./chunk-GPAD5TM5.js";
import {
  require_react_dom
} from "./chunk-7W5AYI3M.js";
import "./chunk-U4ZQRSFH.js";
import {
  useThemeProps
} from "./chunk-JUZW6P4Y.js";
import "./chunk-V2NEPLGC.js";
import "./chunk-QYW4BR32.js";
import {
  useTheme
...
var getValueExtremum = (params) => {
  ...
  return Object.keys(series).filter((seriesId) => {
    ...
    var _a;
    const [seriesMin, seriesMax] = ((_a = series[seriesId].stackedData) == null ? void 0 : _a.reduce((seriesAcc, values) => {
...
var getExtremumX2 = (params) => {
  ...
  return Object.keys(series).filter((seriesId) => {
    ...
    const seriesMinMax = series[seriesId].data.reduce((accSeries, {
      ...
      return mergeMinMax(accSeries, [x2, x2]);
    }, [Infinity, -Infinity]);
...
var getExtremumY2 = (params) => {
  ...
  return Object.keys(series).filter((seriesId) => {
    ...
    const seriesMinMax = series[seriesId].data.reduce((accSeries, {
      ...
      return mergeMinMax(accSeries, [y2, y2]);
    }, [Infinity, -Infinity]);
    return mergeMinMax(acc, seriesMinMax);
  }, [Infinity, -Infinity]);
};
  ...
  return (0, import_jsx_runtime40.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime40.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime40.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime40.jsx)(CartesianProvider, _extends({}, cartesianProviderProps, {
